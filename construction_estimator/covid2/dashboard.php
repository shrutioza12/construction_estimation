...
<?php 
//Total tests
$query=mysqli_query($con,"select id from customer");
$client=mysqli_num_rows($query);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                             All Client</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $client;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <!-- <i class="fas fa-virus fa-2x text-gray-300"></i> -->
                                            <i class="fas fa-sharp fa-solid fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <!-- <i class="fas fa-solid fa-calendar-circle-plus fa-2x text-gray-300"></i> 
