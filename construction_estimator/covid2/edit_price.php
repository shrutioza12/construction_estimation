...
$query="update master set cement='$cement',steel='$steel',worker='$worker',sand='$sand',bricks='$bricks', profit='$profit' where m_id='$pid'";
// print_r($query);exit();
...
echo "<script>window.location.href='edit_price.php'</script>";
}
}
?>
...
$query=mysqli_query($con,"select * from master where m_id='$pid'");
$cnt=1;
