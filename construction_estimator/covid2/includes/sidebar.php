        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link" href="manage-phlebotomist.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>View Client</span></a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="add_price.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>High Construction </span></a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="add_medium_price.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Medium Construction </span></a>
            </li>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                         <a class="collapse-item" href="manage-phlebotomist.php">View Client</a>
              ...
              <!--  <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="add-video.php">Add Photo</a>
                         <a class="collapse-item" href="manage-video.php">View Photo</a>
           ...
           <!--  <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="manage-phlebotomist.php">Add</a>
