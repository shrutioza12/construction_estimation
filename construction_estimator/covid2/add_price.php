...
$query=mysqli_query($con, "delete from master where m_id='$pid'");

  echo "<script>window.location.href='add_price.php'</script>";
}
...
$profit=$_POST['profit'];
    ...
    $query="insert into master(cement,steel,worker,sand,bricks,profit) values('$cement','$steel','$worker','$sand','$bricks','$profit')";
    // print_r($query);exit();
                                ...
                                <table class="table table-bordered" id="dataTable" width="50px" cellspacing="0">
                                    ...
                                    ?>
                                        ...
                                        <tr>  
                                            ...
                                            <th>Action</th>
                                            <td>
                                              <button class="btn btn-info"><a class="text-white" href="edit_price.php?pid=<?php echo $row['m_id'];?>">Edit </a></button>

                                              <button class="btn btn-danger"><a class="text-white" href="add_price.php?pid=<?php echo $row['m_id'];?>&&action=delete" 
